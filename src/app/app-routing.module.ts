...
const routes: Routes = [
  { path: 'auth/signup', component: SignupComponent, data: { isSigninPage: true } },
  { path: 'auth/signin', component: SigninComponent, data: { isSigninPage: true } },
  ...
  { path: '', component: HomeComponent, data: { isSigninPage: true } }
